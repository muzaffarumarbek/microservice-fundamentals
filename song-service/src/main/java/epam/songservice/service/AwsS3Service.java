...
import epam.songservice.config.AwsS3Config;
...
public class AwsS3Service {
    ...
    public SongInfo uploadFileToS3(String fileName, byte[] fileData) {
        ...
        return new SongInfo(fileName, fileUrl, Objects.nonNull(putObjectResult));
    }
